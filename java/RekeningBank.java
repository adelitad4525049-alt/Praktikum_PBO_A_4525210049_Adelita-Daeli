...
public class RekeningBank {
    ...
    public static final double biayaadministrasi = 5000;
    ...
    public RekeningBank(String nomor, String pemilik, double saldoAwal) {
        ...
        if(nomor == null || nomor.isEmpty()){
            throw new IllegalArgumentException ("Nomor Rekening Ga boleh Kosong");
        }
    ...
    public void potongBiayaAdmin() {
        saldo = Math.max(0, saldo - biayaadministrasi);
    }
